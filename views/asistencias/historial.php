<?php
// views/asistencias/historial.php
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <style>
    ...
    .btn-sm {padding:.3rem .6rem;border:1px solid #0d6efd;border-radius:8px;text-decoration:none;color:#0d6efd}
  </style>
</head>
<body>
<div class="box">
  ...
  <nav aria-label="Paginación">
    <ul class="pagination" style="display:flex;gap:.5rem;list-style:none;padding:0;margin-top:1rem">
      ...
      <li><span class="btn-sm" style="pointer-events:none">Página <?= $page ?> de <?= $pages ?></span></li>
